...
<html lang="id">
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        <p>Halo {{ ucfirst($targetRole) }},</p>
        <p>Ada pengajuan baru yang membutuhkan tindakan Anda.</p>
        ...
        <p style="color:#7b8794;font-size:13px">Jika Anda tidak bertanggung jawab terhadap pengajuan ini, abaikan email ini.</p>
      </div>
      <div class="footer">
